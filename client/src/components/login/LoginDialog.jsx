...
const LoginDialog = ({open, setOpen}) => {
    ...
    const [account, toggleAccount] = useState(accountInitivalValues.login);
    ...
    const handelClose = () => {
        setOpen(false);
        toggleAccount(accountInitivalValues.login);
        showError(false);
    }

    const toggleSignup = () => {
        toggleAccount( accountInitivalValues.signup);
    }
