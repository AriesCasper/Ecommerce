import mongoose from 'mongoose';
  ...
  const Connection = async (username, password) => {
    ...
    const URL = `mongodb://${username}:${password}@ac-cleknyb-shard-00-00.00ygsxs.mongodb.net:27017,ac-cleknyb-shard-00-01.00ygsxs.mongodb.net:27017,ac-cleknyb-shard-00-02.00ygsxs.mongodb.net:27017/?ssl=true&replicaSet=atlas-wzhge1-shard-0&authSource=admin&retryWrites=true&w=majority`
    try {
